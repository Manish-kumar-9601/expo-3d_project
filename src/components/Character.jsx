...
useFBX.preload('/assets/animations/hipHopDancing.fbx')
useFBX.preload('/assets/animations/salute.fbx')
useFBX.preload('/assets/animations/victory.fbx')
useFBX.preload('/assets/animations/uprock.fbx')